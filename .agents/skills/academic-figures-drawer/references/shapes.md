...
Before selecting a non-native template or asset source, run
`scripts/assetsearch.py` and follow `visio-and-asset-libraries.md`. There are two
ways to get a native editable draw.io style:
